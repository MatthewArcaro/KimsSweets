...
export function ProductGrid() {
  return (
    <section className="py-20 md:py-32 bg-gradient-to-b from-secondary/40 to-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-7xl font-sans text-balance mb-6 text-foreground">
            Our Specialties 🍰
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, index) => (
            <Card
              key={product.name}
              className={`overflow-hidden hover:shadow-2xl transition-all duration-300 bg-card border-4 border-border/50 rounded-3xl hover:scale-105 ${
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground text-base leading-relaxed font-mono">
                  {product.description}
                </p>
              </CardContent>
            </Card>
